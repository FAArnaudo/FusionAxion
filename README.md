# CDS
Controlador de Surtidores that stands for "CDS" is a software created as an interface between a hardware integration for the gas station pump controller and the management system.
This system is an implementation for a dispenser controller hardware named CEM-44 and FUSION but could be extended for more pump control systems.
