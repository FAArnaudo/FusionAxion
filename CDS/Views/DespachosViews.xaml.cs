    ...
    public partial class DespachosViews : Window
    {
        ...
        private void DespachosViews_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            switch (controller)
            {
                ...
                case "FUSION":
                    DG_Despachos.Columns.Add(CreateTextColumn("Fecha", "fecha", 120));
                    DG_Despachos.Columns.Add(CreateTextColumn("AUC", "AUC", 80));
                    DG_Despachos.Columns.Add(CreateTextColumn("TXTD", "TXTD", 130));
                    query += "fecha, AUC, TXTD FROM Despachos ORDER BY fecha DESC";
                    break;
                default:
